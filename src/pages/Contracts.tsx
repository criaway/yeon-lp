        ...
        <div className="space-y-4">
          ...
          <div className="bg-secondary/50 p-4 rounded-lg border border-white/10">
            <p className="text-sm text-gray-300">
              ...
              específica. Recomendamos sempre consultar um advogado
              especializado antes de assinar qualquer documento legal.
            </p>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row gap-6">
            <div className="md:w-2/3">
              ...
              <p className="text-gray-300 mb-4">
                Precisa de um contrato personalizado ou tem dúvidas sobre
                direitos autorais e propriedade intelectual na música?
              </p>
              <p className="text-gray-300">
                Entre em contato com nossa equipe jurídica para uma consultoria
                especializada que atenda às suas necessidades específicas.
              </p>
