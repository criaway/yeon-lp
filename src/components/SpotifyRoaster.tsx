  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        const randomRoast =
          selectedRoasts[Math.floor(Math.random() * selectedRoasts.length)];
      ...
      <div className="space-y-6">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-muted-foreground max-w-md">
            Compartilhe o perfil de um artista no Spotify e nossa IA vai fritar
            sem dó. É diversão garantida (ou pelo menos tentamos).
          </p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Copie o link de um perfil de artista do Spotify e cole abaixo para
              receber uma análise nada amigável.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div className="mt-2">
                <p className="text-sm font-medium mb-2">
                  Escolha a intensidade da fritada:
                </p>
                <RadioGroup
                  value={intensity}
                  onValueChange={(value) =>
                    setIntensity(value as RoastIntensity)
                  }
