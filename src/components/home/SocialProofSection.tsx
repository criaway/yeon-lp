...
const StatItem: React.FC<StatItemProps> = ({ value, label }) => {
  return (
    <div className="flex flex-col items-center text-center">
      <span className="text-4xl md:text-5xl font-semibold text-yeon-orange mb-2">
        {value}
      </span>
...
const SocialProofSection: React.FC = () => {
  ...
  const testimonials = [
    {
      quote:
        "A Yeon Music transformou completamente minha carreira. Agora consigo gerir meus lançamentos e acompanhar meus ganhos de forma muito mais eficiente.",
    ...
    {
      quote:
        "A ferramenta de cálculo de ganhos é incrivelmente precisa. Me ajudou a entender quais plataformas estão gerando mais receita para minha música.",
      author: "Rafael Costa",
      role: "Produtor Musical",
      image:
        "https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?ixlib=rb-4.0.3&auto=format&fit=crop&w=120&q=80",
    },
    {
      quote:
        "O suporte ao artista e as ferramentas de marketing me ajudaram a alcançar novos públicos que eu nunca teria descoberto sozinho.",
      author: "Marina Silva",
      role: "Cantora e Compositora",
      image:
        "https://images.unsplash.com/photo-1534528741775-53994a69daeb?ixlib=rb-4.0.3&auto=format&fit=crop&w=120&q=80",
    },
  ];
